...
### 1.4.1 Example: Ship Radar Sensitivity
...
### 1.4.2 Example: Surface Scanning
...
## 1.5 How Much Can You Scan? (Effective Scanning Volume)
...
## 1.7 Surface Scanning vs. Altitude
...
## 1.9 RS Signature Values by Resource Type
